...
exports.loginUser = catchAsyncErrors(async (req, res, next) => {
  ...
  //checking if usr has given both
...
exports.resetPassword = catchAsyncErrors(async (req, res, next) => {
  // creating token hash to find in db
...
exports.getSingleUserDetails = catchAsyncErrors(async (req, res, next) => {
  ...
  if (!user) {
    return next(
      new ErrorHandler(`Entered user id: ${req.body.id} does not exsists`)
    );
  }
...
exports.updateUserRole = catchAsyncErrors(async (req, res, next) => {
  ...
  if (!userC) {
    return next(
      new ErrorHandler(`Entered user id: ${req.params.id} does not exsists`)
    );
  }
  const newUserData = {
    name: req.body.name,
